...
module.exports = class HALSerializer {
  ...
  serializeEmbedded(data, options, links) {
    ...
    _.forOwn(options.embedded, (rOptions, embedded) => {
      ...
      _.set(SerializedEmbedded, embedded, this.serializeEmbeddedResource(embedded, data[embedded], rOptions, this.schemas[options.embedded[embedded].type][schema], links));
    });
